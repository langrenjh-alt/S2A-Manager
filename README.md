...
>
> **[前往新仓库：langrenjh-alt/S2AM-GO](https://github.com/langrenjh-alt/S2AM-GO)**
...
- 当前项目：[S2AM-GO](https://github.com/langrenjh-alt/S2AM-GO)
...
- 支持账号优先级规则：可按账号倍率排序，也可结合 Sub2API 流式使用记录的平均首字时间与账号倍率计算调度优先级；综合策略支持按分钟设置回看窗口。
